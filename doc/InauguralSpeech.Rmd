...
```{r}
#inauglist.csv should be generated here
...
speech.list=rbind(inaug.list, Trump.speeches)
```
...
#sel.comparison=levels(sentence.list$FileOrdered)
sentence.list.sel=filter(sentence.list, 
                        type=="inaug", Term==2, File%in%sel.comparison)
sentence.list.sel$File=factor(sentence.list.sel$File)
...
beeswarm(word.count~FileOrdered, 
         ...
         las=2, xlab="Number of words in a sentence.", ylab="",
         main="Inaugural speeches, 2nd term")
